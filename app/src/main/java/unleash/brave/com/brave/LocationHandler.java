...
import com.github.akashandroid90.googlesupport.location.AppLocation;
import com.github.akashandroid90.googlesupport.location.GoogleContextSupportLocation;
...
public class LocationHandler extends AppCompatActivity implements GoogleContextSupportLocation {
...
//                mLocationSettingsStates = result.getLocationSettingsStates();
                switch (status.getStatusCode()) {
                    ...
                    case LocationSettingsStatusCodes.RESOLUTION_REQUIRED:
                        ...
                        try {
                            ...
                            status.startResolutionForResult(LocationHandler.this, REQUEST_CHECK_SETTINGS);
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        mGoogleApiClient = new GoogleApiClient.Builder(this).addApi(LocationServices.API).addApi(Auth.GOOGLE_SIGN_IN_API, gso).enableAutoManage(this, this).
...
//        }
        ...
        if (servicesConnected()) {
            if (enableUpdates) {
                if (ActivityCompat.checkSelfPermission(this, android.Manifest.permission.ACCESS_FINE_LOCATION) != PackageManager.PERMISSION_GRANTED
                    ...
                    ActivityCompat.requestPermissions(this, new String[]{android.Manifest.permission.ACCESS_FINE_LOCATION, android.Manifest.permission.ACCESS_COARSE_LOCATION}, ACCESS_FUSED_LOCATION);
                else {
    ...
    public Location requestForCurrentLocation() {
        ...
        if (currentLocation == null) {
            ...
            if (ActivityCompat.checkSelfPermission(this, android.Manifest.permission.ACCESS_FINE_LOCATION) != PackageManager.PERMISSION_GRANTED
                    && ActivityCompat.checkSelfPermission(this, android.Manifest.permission.ACCESS_COARSE_LOCATION) != PackageManager.PERMISSION_GRANTED)
                ActivityCompat.requestPermissions(this, new String[]{android.Manifest.permission.ACCESS_FINE_LOCATION, android.Manifest.permission.ACCESS_COARSE_LOCATION}, ACCESS_LOCATION);
            ...
            if (ActivityCompat.checkSelfPermission(this, android.Manifest.permission.ACCESS_COARSE_LOCATION) != PackageManager.PERMISSION_GRANTED
                ...
                ActivityCompat.requestPermissions(this, new String[]{android.Manifest.permission.ACCESS_COARSE_LOCATION}, ACCESS_COARSE_LOCATION);
            else
    ...
    public void onRequestPermissionsResult(int requestCode, String[] permissions, int[] grantResults) {
        ...
        switch (requestCode) {
            case ACCESS_COARSE_LOCATION:
                if ((permissions.length > 0 && permissions[0].equalsIgnoreCase(android.Manifest.permission.ACCESS_COARSE_LOCATION)) && (grantResults.length > 0 && grantResults[0] == PackageManager.PERMISSION_GRANTED))
                    requestForCurrentLocation();
                else onRequestPermissionsResultError(requestCode, permissions, grantResults);
                break;
            case ACCESS_FINE_LOCATION:
                if ((permissions.length > 0 && permissions[0].equalsIgnoreCase(android.Manifest.permission.ACCESS_FINE_LOCATION)) && (grantResults.length > 0 && grantResults[0] == PackageManager.PERMISSION_GRANTED))
                    requestForCurrentLocation();
                else onRequestPermissionsResultError(requestCode, permissions, grantResults);
                break;
            case ACCESS_LOCATION:
                if (permissions.length > 0 && ((permissions[0].equalsIgnoreCase(android.Manifest.permission.ACCESS_FINE_LOCATION)
                        || permissions[1].equalsIgnoreCase(android.Manifest.permission.ACCESS_FINE_LOCATION)) ||
                        ((permissions[0].equalsIgnoreCase(android.Manifest.permission.ACCESS_COARSE_LOCATION)
                                || permissions[1].equalsIgnoreCase(android.Manifest.permission.ACCESS_COARSE_LOCATION))))) {
