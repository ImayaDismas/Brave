...
public class WeatherFragment extends Fragment {
    ...
    private void renderWeather(JSONObject json){
        try {
            ...
            currentTemperature.setText(String.format("%.2f", ((main.getDouble("temp") * 9 / 5.0) + 32))+ " °F");

            SimpleDateFormat mdyFormat = new SimpleDateFormat("MM-dd-yyyy");
            DateFormat dateFormat = new SimpleDateFormat("hh:mm");
            Date date = new Date();
            currentTime.setText(dateFormat.format(date));
            currentDate.setText(mdyFormat.format(date));

            DateFormat df = DateFormat.getDateTimeInstance();
            String updatedOn = df.format(new Date(json.getLong("dt")*1000));
//            updatedField.setText("Last update: " + updatedOn);
            updatedField.setText("(" + LATLONG + ")");
            ...
            Log.e("Brave", "One or more fields not found in the JSON data");
        }
    }
